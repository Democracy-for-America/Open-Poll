class Admin::PollsController < ApplicationController
  ...
  private
    ...
    def poll_params
      params.require(:poll).permit(:title, :subtitle, :name, :short_name, :actionkit_page, :instructions, :email_template, :results_text, :custom_css, :end_voting, :show_results, :facebook_image, :logo)
    end
end
